from python_basic_56_menu_item import MenuItem
...
# '個数を入力してください(3つ以上で1割引): 'と表示してから、コンソールの入力を受け取るようにしてください。
# また、受け取った内容を数値に変換し、変数countに代入してください。
count = int(input('個数を入力してください(3つ以上で1割引):'))

# get_total_price メソッドを呼び出してください
# 変数selected_menuに対してget_total_priceメソッドを呼び出し、その戻り値を変数resultに代入してください。
# ただし、get_total_priceメソッドを呼び出す際の引数はcountとしてください。
result = selected_menu.get_total_price(count)

# 「 合計は〇〇円です 」となるように出力してください
print('合計は' + str(round(result)) + '円です')