from python_basic_63_food import Food
from python_basic_63_drink import Drink
...
# コンソールから入力を受け取り、数値に変換し、変数 count に代入してください
# 何セット買いますか？(3つ以上で1割引): と表示してから、
# コンソールの入力を受け取るようにしてください。
count = int(input('何セット買いますか？(3つ以上で1割引:)'))

# selected_food と selected_drink のそれぞれに対して、 
# get_total_price メソッドを呼び出し、変数 result に代入してください
